...
public class Main extends Application{
    ...
    Image IMAGE1 = new Image(getClass().getResourceAsStream("Pictires/human_1.png"));
    Image IMAGE2 = new Image(getClass().getResourceAsStream("Pictires/human_2.png"));
    Image IMAGE3 = new Image(getClass().getResourceAsStream("Pictires/fon.jpg"));
    Image StageIcon = new Image(getClass().getResourceAsStream("Pictires/stageicon.png"));
    ...
    Media media = new Media("File:///D:/Алексей/Программы/work_space/JavaGame/src/Music/music.mp3");
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setTitle("Ninja Game");
